  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="0" id="3">
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="2">
          <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
            <property name="value" class="String">http://www.oem.com.mx/tribunadesanluis/rss/rss_mexico.xml</property>
          </property>
      ...
      <object class="Transition" serializationversion="0" id="19">
        <property name="name" class="String">Extract Article Text (content:encoded)</property>
        <property name="stepAction" class="Extract" serializationversion="1">
