    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="5">
        ...
        <property name="stepAction" class="LoadPage">
          <property name="urlProvider" class="kapow.robot.plugin.common.support.url.provider.SpecifiedURLProvider">
            <property name="url" class="String">http://www.cronica.com.py/category/actualidad/</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="13">
        ...
        <property name="stepAction" class="ForEachURL" serializationversion="0">
          <property name="pattern" class="kapow.robot.plugin.common.support.expression.stringexpr.PatternValueStringExpression">
            <property name="value" class="String">http://www.cronica.com.py/\d\d\d\d/\d\d/\d\d/.*/</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="25">
              ...
              <property name="formats" class="BeanList">
                <object class="kapow.robot.plugin.common.stringprocessor.datefetcher.PatternBasedDateFormatSpecification">
                  ...
                  <property name="locale" class="kapow.robot.plugin.common.support.expression.stringexpr.LocaleValueStringExpression">
                    <property name="value" class="String">es_PY</property>
                  </property>
                </object>
              </property>
            </element>
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            <property name="nodePath" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
              <property name="value" class="String">.*.div.div.div.div.div.span.text[1]</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0">
