...
<object class="Robot" serializationversion="2">
    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="5">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ValueURLProvider2">
            <property name="URL" class="String">http://www.mexat.com/vb/external.php?type=RSS2&amp;forumids=198,365,360,381,141,3,5,281,86,233,226,220,378,377,9,375,379,374</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="11">
        ...
        <property name="stepAction" class="ForEachURL" serializationversion="0">
          <property name="pattern" class="kapow.robot.plugin.common.support.expression.stringexpr.PatternValueStringExpression">
            <property name="value" class="String">.*xml</property>
          </property>
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            <property name="nodePath" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
              <property name="value" class="String">.*.div.div.div.div.div.div.div.div.div.p[2]</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0">
      ...
      <object class="Transition" serializationversion="3" id="22">
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            ...
            <property name="nodePath" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
              <property name="value" class="String">.*.div[2].div</property>
            </property>
      ...
      <object class="Transition" serializationversion="3" id="31">
        ...
        <property name="stepAction" class="LoadPage2">
          ...
          <property name="browserConfigurationSpecification" class="kapow.robot.plugin.common.support.browser2.BrowserConfigurationSpecificationClassic" serializationversion="24">
            ...
            <property name="userAgentProvider" class="kapow.robot.plugin.common.support.browser2.PredefinedUserAgentProvider">
              <property name="userAgent" class="com.kapowtech.net.UserAgent">
                <property name="appCodeName" class="String" id="32">Mozilla</property>
                <property name="appMinorVersion" class="String" id="33"/>
                <property name="appName" class="String" id="34">Netscape</property>
                <property name="appVersion" class="String" id="35">5.0 (Windows; en-US)</property>
                <property name="displayName" class="String" id="36">Firefox 2.0 on Windows XP</property>
                <property name="name" class="String" id="37">Firefox_20_WinXP</property>
                <property name="platform" class="String" id="38">Win32</property>
                <property name="userAgentHeaderValue" class="String" id="39">Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8) Gecko/20061010 Firefox/2.0</property>
              </property>
            </property>
            <property name="xSLStyleSheetEnabled" class="Boolean">false</property>
            <property name="loadFrames" class="Boolean">false</property>
      ...
      <object class="Transition" serializationversion="3" id="40">
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            <property name="nodePath" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
              <property name="value" class="String">.*.div.div.div.div.ol.li.div.div.div</property>
            </property>
            <property name="attributeName" idref="23"/>
            <property name="attributeValue" class="kapow.robot.plugin.common.support.predicate.unary.string.FixedStringPredicate">
              <property name="text" class="String">postrow has_after_content</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0">
  ...
  <property name="browserConfigurationSpecification" class="kapow.robot.plugin.common.support.browser2.BrowserConfigurationSpecificationClassic" serializationversion="24">
    ...
    <property name="userAgentProvider" class="kapow.robot.plugin.common.support.browser2.PredefinedUserAgentProvider">
      <property name="userAgent" class="com.kapowtech.net.UserAgent">
        <property name="appCodeName" idref="32"/>
        <property name="appMinorVersion" idref="33"/>
        <property name="appName" idref="34"/>
        <property name="appVersion" idref="35"/>
        <property name="displayName" idref="36"/>
        <property name="name" idref="37"/>
        <property name="platform" idref="38"/>
        <property name="userAgentHeaderValue" idref="39"/>
      </property>
    </property>
    <property name="xSLStyleSheetEnabled" class="Boolean">false</property>
    <property name="loadFrames" class="Boolean">false</property>
