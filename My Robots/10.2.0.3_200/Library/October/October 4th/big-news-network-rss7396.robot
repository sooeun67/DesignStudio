      ...
      <object class="Transition" serializationversion="3" id="5">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ValueURLProvider2">
            <property name="URL" class="String">https://www.bignewsnetwork.com/show-rss</property>
          </property>
          <property name="browserConfigurationSpecification" class="BrowserConfigurationSpecificationWebKit" serializationversion="24">
            ...
            <property name="userAgentProvider" class="kapow.robot.plugin.common.support.browser2.PredefinedUserAgentProvider">
              <property name="userAgent" class="com.kapowtech.net.UserAgent">
                ...
                <property name="appName" class="String">Chrome</property>
                <property name="appVersion" class="String">27.0 (Windows; en-US)</property>
                <property name="displayName" class="String">Chrome 27.0 on Windows 7</property>
                <property name="name" class="String">Chrome_270_Win7</property>
                <property name="platform" class="String">Win32</property>
                <property name="userAgentHeaderValue" class="String">Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.110 Safari/537.36</property>
              </property>
            </property>
            ...
            <property name="migrationNotes" class="kapow.robot.plugin.common.support.Text">
              <property name="text" class="String">Property changed and no longer supported: Enable Absolute Positioning: true
...
Property changed and no longer supported: Apply XSL Style Sheets: false
Default value changed for Output Page If Timeout: false -&gt; true
Property changed and no longer supported: Max. Window Nesting: null
Property changed and no longer supported: Load Unsupported Formats: false</property>
            </property>
      ...
      <object class="Transition" serializationversion="3" id="12">
        ...
        <property name="stepAction" class="ForEachURL" serializationversion="0">
          <property name="pattern" class="kapow.robot.plugin.common.support.expression.stringexpr.PatternValueStringExpression">
            <property name="value" class="String">https://feeds.bignewsnetwork.com/category/876f91efcbd818cb|https://feeds.bignewsnetwork.com/category/57ef06a09618a2d6</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders">
...
Default value changed for HTTP User Agent: null -&gt; kapow.robot.plugin.common.support.expression.stringexpr.PresetUserAgentStringExpression(userAgent="Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.134 Safari/537.36")
Default value changed for Output Page If Timeout: false -&gt; true
Property changed and no longer supported: Max. Window Nesting: null</property>
            </property>
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            ...
            <property name="matchAgainst" class="kapow.robot.robomaker.state.document.nodefinder.defaultnodefinder.AbstractDefaultDOMElementFinder$PatternMatchTextType" id="14">
      ...
      <object class="Transition" serializationversion="3" id="17">
        <property name="name" class="String">For Each XML Tag</property>
        <property name="stepAction" class="ForEachXMLTag" serializationversion="0">
      ...
      <object class="Transition" serializationversion="3" id="24">
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            ...
            <property name="matchAgainst" idref="14"/>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0">
          <property name="reportingViaAPI" class="Boolean">false</property>
          ...
          <property name="conditions" class="kapow.robot.plugin.common.stateprocessor.attributefilter.AttributeFilterConditions">
            <object class="kapow.robot.plugin.common.stateprocessor.attributefilter.AttributeFilterCondition">
              ...
              <property name="expression" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
                <property name="value" class="String">bignewsnetwork</property>
              </property>
            </object>
            <object class="kapow.robot.plugin.common.stateprocessor.attributefilter.AttributeFilterCondition">
              <property name="attributeName" class="kapow.robot.plugin.common.support.AttributeName">
              ...
              <property name="expression" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
                <property name="value" class="String">/bildstrecken/</property>
              </property>
            </object>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="30">
        ...
        <property name="stepAction" class="LoadPage2">
          ...
          <property name="browserConfigurationSpecification" class="BrowserConfigurationSpecificationWebKit" serializationversion="24">
            ...
            <property name="userAgentProvider" class="kapow.robot.plugin.common.support.browser2.PredefinedUserAgentProvider">
              <property name="userAgent" class="com.kapowtech.net.UserAgent">
                <property name="appCodeName" class="String" id="31">Mozilla</property>
                <property name="appMinorVersion" class="String" id="32"/>
                <property name="appName" class="String" id="33">Netscape</property>
                <property name="appVersion" class="String" id="34">5.0 (Windows; en-US)</property>
                <property name="displayName" class="String" id="35">Firefox 2.0 on Windows XP</property>
                <property name="name" class="String" id="36">Firefox_20_WinXP</property>
                <property name="platform" class="String" id="37">Win32</property>
                <property name="userAgentHeaderValue" class="String" id="38">Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8) Gecko/20061010 Firefox/2.0</property>
              </property>
            </property>
            <property name="loadFrames" class="Boolean">false</property>
            <property name="executeJavaScript" class="Boolean">false</property>
...
Property changed and no longer supported: Load Unsupported Formats: false</property>
      ...
      <object class="Transition" serializationversion="3" id="39">
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            ...
            <property name="attributeValue" class="kapow.robot.plugin.common.support.predicate.unary.string.FixedStringPredicate">
              <property name="text" class="String">article-blah</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
      ...
      <object class="SnippetStep" id="41">
        <name class="String" id="42">DoubRestWebkit</name>
        <snippetName idref="42"/>
        <snippetStepComment>
          <null/>
        </snippetStepComment>
      </object>
  ...
  <property name="browserConfigurationSpecification" class="BrowserConfigurationSpecificationWebKit" serializationversion="24">
    ...
    <property name="userAgentProvider" class="kapow.robot.plugin.common.support.browser2.PredefinedUserAgentProvider">
      <property name="userAgent" class="com.kapowtech.net.UserAgent">
        <property name="appCodeName" idref="31"/>
        <property name="appMinorVersion" idref="32"/>
        <property name="appName" idref="33"/>
        <property name="appVersion" idref="34"/>
        <property name="displayName" idref="35"/>
        <property name="name" idref="36"/>
        <property name="platform" idref="37"/>
        <property name="userAgentHeaderValue" idref="38"/>
      </property>
    </property>
    <property name="loadFrames" class="Boolean">false</property>
    <property name="executeJavaScript" class="Boolean">false</property>
