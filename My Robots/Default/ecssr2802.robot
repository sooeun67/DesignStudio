...
<object class="Robot" serializationversion="2">
    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="5">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ValueURLProvider2">
            <property name="URL" class="String">http://www.ecssr.com/ECSSR/rss?lang=ar&amp;catId=ec_news</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="11">
        ...
        <property name="stepAction" class="ForEachURL" serializationversion="0">
          <property name="pattern" class="kapow.robot.plugin.common.support.expression.stringexpr.PatternValueStringExpression">
            <property name="value" class="String">http://www.ecssr.com/ECSSR/rss?lang=ar&amp;catId=ec_activities|http://www.ecssr.com/ECSSR/rss?lang=ar&amp;catId=ec_fea_topics|http://www.ecssr.com/ECSSR/rss?lang=ar&amp;catId=ec_news</property>
          </property>
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            <property name="nodePath" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
              <property name="value" class="String">.*.div.div.div.div.div.div.div.div.div.div.div.table</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0">
      ...
      <object class="Transition" serializationversion="3" id="21">
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            ...
            <property name="attributeValue" class="kapow.robot.plugin.common.support.predicate.unary.string.FixedStringPredicate">
              <property name="text" class="String">dc:date</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0">
      ...
      <object class="Transition" serializationversion="3" id="29">
        ...
        <property name="stepAction" class="LoadPage2">
          ...
          <property name="browserConfigurationSpecification" class="kapow.robot.plugin.common.support.browser2.BrowserConfigurationSpecificationClassic" serializationversion="24">
            ...
            <property name="userAgentProvider" class="kapow.robot.plugin.common.support.browser2.PredefinedUserAgentProvider">
              <property name="userAgent" class="com.kapowtech.net.UserAgent">
                <property name="appCodeName" class="String" id="30">Mozilla</property>
                <property name="appMinorVersion" class="String" id="31"/>
                <property name="appName" class="String" id="32">Netscape</property>
                <property name="appVersion" class="String" id="33">5.0 (Windows; en-US)</property>
                <property name="displayName" class="String" id="34">Firefox 2.0 on Windows XP</property>
                <property name="name" class="String" id="35">Firefox_20_WinXP</property>
                <property name="platform" class="String" id="36">Win32</property>
                <property name="userAgentHeaderValue" class="String" id="37">Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8) Gecko/20061010 Firefox/2.0</property>
              </property>
            </property>
            <property name="xSLStyleSheetEnabled" class="Boolean">false</property>
            <property name="loadFrames" class="Boolean">false</property>
      ...
      <object class="Transition" serializationversion="3" id="38">
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            <property name="nodePath" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
              <property name="value" class="String">.*.div.div.div.div.div.div.table.*.div.div.div.div.div.div.table.*.tr[2].*.table.tbody</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
  ...
  <property name="browserConfigurationSpecification" class="kapow.robot.plugin.common.support.browser2.BrowserConfigurationSpecificationClassic" serializationversion="24">
    ...
    <property name="userAgentProvider" class="kapow.robot.plugin.common.support.browser2.PredefinedUserAgentProvider">
      <property name="userAgent" class="com.kapowtech.net.UserAgent">
        <property name="appCodeName" idref="30"/>
        <property name="appMinorVersion" idref="31"/>
        <property name="appName" idref="32"/>
        <property name="appVersion" idref="33"/>
        <property name="displayName" idref="34"/>
        <property name="name" idref="35"/>
        <property name="platform" idref="36"/>
        <property name="userAgentHeaderValue" idref="37"/>
      </property>
    </property>
    <property name="xSLStyleSheetEnabled" class="Boolean">false</property>
    <property name="loadFrames" class="Boolean">false</property>
